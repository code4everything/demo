        ...
        14: [function (t, e, n) {
            (function (n) {
                ...
                a(r, y), r.prototype.close = function (t, e) {
                    ...
                    this.readyState === r.CONNECTING && (this._transport && this._transport.close(), this._transportClose(2007, "Transport timed out"))
                }, r.prototype._transportMessage = function (t) {
        ...
        17: [function (t, e, n) {
            (function (n) {
                ...
                o(r, i), r.prototype._start = function (t, e, n, i) {
                    ...
                    if (i && i.noCredentials || !r.supportsCORS || (this.xhr.withCredentials = !0), i && i.headers) for (var u in i.headers) this.xhr.setRequestHeader(u, i.headers[u]);
        ...
        31: [function (t, e, n) {
            (function (n) {
                ...
                l(r, u), r.prototype.abort = function () {
                    ...
                    if (i.id = "a" + o.string(8), i.src = t, i.type = "text/javascript", i.charset = "UTF-8",
                        i.onerror = this._scriptError.bind(this), i.onload = function () {
        ...
        58: [function (t, e, n) {
            (function (n) {
                ...
                function r(t) {
                    t = t || n.location || {};
                    var e, r = {}, i = typeof t;
                    if ("blob:" === t.protocol) r = new s(unescape(t.pathname), {}); else if ("string" === i) {
                        r = new s(t, {});
                        for (e in p) delete r[e]
                    } else if ("object" === i) {
                        for (e in t) e in p || (r[e] = t[e]);
                        void 0 === r.slashes && (r.slashes = h.test(t.href))
                    }
                    return r
                }
                ...
                function s(t, e, n) {
                    ...
                    var a, l, f, h, p, v, m = d.slice(), b = typeof e, y = this, g = 0;
                    for ("object" !== b && "string" !== b && (n = e, e = null), n && "function" != typeof n && (n = c.parse), e = r(e), l = i(t || ""), a = !l.protocol && !l.slashes, y.slashes = l.slashes || a && e.slashes, y.protocol = l.protocol || e.protocol || "", t = l.rest, l.slashes || (m[2] = [/(.*)/, "pathname"]); g < m.length; g++) h = m[g], f = h[0], v = h[1], f !== f ? y[v] = t : "string" == typeof f ? ~(p = t.indexOf(f)) && ("number" == typeof h[2] ? (y[v] = t.slice(0, p), t = t.slice(p + h[2])) : (y[v] = t.slice(p), t = t.slice(0, p))) : (p = f.exec(t)) && (y[v] = p[1], t = t.slice(0, p.index)), y[v] = y[v] || (a && h[3] ? e[v] || "" : ""), h[4] && (y[v] = y[v].toLowerCase());
                    n && (y.query = n(y.query)), a && e.slashes && "/" !== y.pathname.charAt(0) && ("" !== y.pathname || "" !== e.pathname) && (y.pathname = o(y.pathname, e.pathname)), u(y.port, y.protocol) || (y.host = y.hostname, y.port = ""), y.username = y.password = "", y.auth && (h = y.auth.split(":"), y.username = h[0] || "", y.password = h[1] || ""), y.origin = y.protocol && y.host && "file:" !== y.protocol ? y.protocol + "//" + y.host : "null", y.href = y.toString()
                }
                ...
                var u = t("requires-port"), c = t("querystringify"), f = /^([a-z][a-z0-9.+-]*:)?(\/\/)?([\S\s]*)/i,
                    h = /^[A-Za-z][A-Za-z0-9+-.]*:\/\//,
                    d = [["#", "hash"], ["?", "query"], ["/", "pathname"], ["@", "auth", 1], [NaN, "host", void 0, 1, 1], [/:(\d+)$/, "port", void 0, 1], [NaN, "hostname", void 0, 1, 1]],
                    p = {hash: 1, query: 1};
                s.prototype = {set: a, toString: l}, s.extractProtocol = i, s.location = r, s.qs = c, e.exports = s
            }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
