 ...
 * @since 2019/10/16
 */
@Service(value = "twoThrift")
public class ThriftServiceTwoImpl implements ThriftService.Iface {

    @Override
    public void test() {
        Console.log("hello thrift two");
    }
    ...
    public ThriftResponse doRequest(ThriftRequest request) {
        ...
        response.setResult(CollUtil.newArrayList("hello", "thrift", "two"));
        return response;
    }
}
