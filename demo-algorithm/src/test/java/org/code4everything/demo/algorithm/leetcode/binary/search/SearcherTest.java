...
public class SearcherTest {
    ...
    public void findMedianSortedArrays() {
        assert searcher.findMedianSortedArrays(new int[]{1, 2}, new int[]{3, 4}) == 2.5;
        assert searcher.findMedianSortedArrays(new int[]{1, 3}, new int[]{2}) == 2;
    }

    @Test
    public void smallestDistancePair() {
        assert searcher.smallestDistancePair(new int[]{1, 3, 1}, 1) == 0;
